...
Data Collection – Gathering textual dataset
Data Preprocessing – Cleaning, tokenization, stopword removal
Feature Engineering – TF-IDF vectorization or embeddings
Model Training – Applying ML algorithms (e.g., Logistic Regression, Naive Bayes)
Prediction – Classifying sentiment based on trained model
📊 Sample Output
